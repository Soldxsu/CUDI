...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['id_dia']) && !empty($_POST['id_dia'])) {
        ...
        if ($con->query($sql) === TRUE) {
            ...
            echo "<p style='color:red;'>Error al actualizar el registro: " . $con->error . "</p>";
        }
    } else {
        ...
        if ($con->query($sql) === TRUE) {
            ...
            echo "<p style='color:red;'>Error al crear el registro: " . $con->error . "</p>";
        }
    }
}

$jornada_options = $con ->query("SELECT id_jornada, dias FROM jornada");
$aulas_options = $con->query("SELECT id_aula, numero FROM aulas");
$materias_options = $con->query("SELECT id_materia, nombre FROM materias");
$itinerarios_options = $con->query("SELECT id_itinerario, horario FROM itinerario");
?>
...
<body>
    <div class="form-container">
        ...
        <form action="disposicionaulica.php" method="POST">
            <?php if (!empty($id_dia)): ?>
